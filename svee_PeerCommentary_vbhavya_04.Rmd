...
*Oct 29: I caught a mistake in my own code while doing peer commentary, I came back to fix it -sam*
...
## Making the function
Module 10 provided the equation for determining the z statistic, it also helped me write the code for determining confidence intervals. Module 11 helped me write the code for testing alternatives. I also referenced source code from functions t.test() and prop.test()
```{r one sample}
...
# two sample z test
  ...
  ci <- c(lower, upper)
    ...
    two.sample.proptest <- list(test.type = "One-Sample Proportion Z-test", 
                                alternative = alternative,
...
# everything in this chunk runs but does it do the stats correctly?
```

## Testing the function: one-sample Z test
I fried my brain making the actual functions, I have no time/energy to test them out. I'll get back to this for my final homework submission! Would appreciate it if my peer reviewers could plug in some values and test it for me!!
[...]
